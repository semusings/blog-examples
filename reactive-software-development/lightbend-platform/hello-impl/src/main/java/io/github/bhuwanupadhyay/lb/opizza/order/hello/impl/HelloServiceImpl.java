...
import io.github.bhuwanupadhyay.lb.opizza.order.hello.api.GreetingMessage;
import io.github.bhuwanupadhyay.lb.opizza.order.hello.api.HelloService;
import io.github.bhuwanupadhyay.lb.opizza.order.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<io.github.bhuwanupadhyay.lb.opizza.order.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      io.github.bhuwanupadhyay.lb.opizza.order.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new io.github.bhuwanupadhyay.lb.opizza.order.hello.api.HelloEvent.GreetingMessageChanged(
