 ...
 *         &lt;element name="Frqcy" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}Frequency36Choice" minOccurs="0"/>
 *         &lt;element name="Drtn" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}DatePeriodDetails1" minOccurs="0"/>
 *         &lt;element name="FrstColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="FnlColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}ISODate" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MandateOccurrences4", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05", propOrder = {
    "seqTp",
    "frqcy",
    "drtn",
    "frstColltnDt",
...
public class MandateOccurrences4 {
    ...
    @XmlElement(name = "SeqTp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05", required = true)
    @XmlSchemaType(name = "string")
    protected SequenceType2Code seqTp;
    @XmlElement(name = "Frqcy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05")
    protected Frequency36Choice frqcy;
    @XmlElement(name = "Drtn", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05")
    protected DatePeriodDetails1 drtn;
    @XmlElement(name = "FrstColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar frstColltnDt;
    @XmlElement(name = "FnlColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.05")
    @XmlSchemaType(name = "date")
